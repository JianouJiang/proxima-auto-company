# SixDegrees - AI Agent Connection Service
...
SixDegrees takes the "6 degrees of separation" concept and automates it with AI:
...
- SixDegrees Starter (£5) - custom field: `plan=starter`
- SixDegrees Growth (£20) - custom field: `plan=growth`
- SixDegrees Pro (£50) - custom field: `plan=pro`
- SixDegrees Unlimited (£99) - custom field: `plan=unlimited`
